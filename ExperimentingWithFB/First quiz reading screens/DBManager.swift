        ...
        if questionAnswered ?? false {
                        ...
                        if let error {
                            ...
                            for question in querySnapshot!.documents {
                                if let question1 = question["question_1"] {
                                    print(question1) //it tells me the value isn't a boolean when it actually is (in my database), the problem must be that it considers question 1 and 2 at the same time (supposition)
                                }
                            }
                        }
                    }
                    ...
                    Firestore.firestore().collection("New questions").document("question_bank").collection("quiz_2").getDocuments() {
                        ...
                        if let error {
                            ...
                            for question in querySnapshot!.documents {
                                if let question1 = question["question_1"] {
                                    print(question1) //it tells me the value isn't a boolean when it actually is (in my database)
                                }
                            }
                        }
